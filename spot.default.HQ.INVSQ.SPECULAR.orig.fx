...
float4 main(PS_IN i) : SV_Target
{
	...
	r0.x = r0.x * r3.w;
	r2.w = dot(r1.ww, r0.xx) + 0;
	r4 = r0.x * ref_light_color.xyzz;
	r0.x = dot(r2.xyz, r2.xyz);
	r0.x = 1 / sqrt(r0.x);
	r2.xyz = (half3)(r2.xyz * r0.xxx + r3.xyz);
	r3.xyz = normalize(r2.xyz);
	r0.x = saturate(dot(r3.xyz, r0.yzw));
	r0.y = lerp(10, 210, r1.w);
	r1.w = pow(r0.x, r0.y);
	r0.x = 1;
	r0.x = saturate(-r0.x + ref_light_falloff_exponent.x);
	r0.x = r0.x * 0.33 + 1;
	r0.x = r0.x * r1.w;
	r0.x = r2.w * r0.x;
	r0 = r0.x * ref_light_color.xyzz;
